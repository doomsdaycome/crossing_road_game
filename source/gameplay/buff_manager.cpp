...
bool BuffManager::isMagnetActive() const { return magnetActive_; }

bool BuffManager::isInvisible() const { return invisibilityActive_; }
...
void BuffManager::addInvisibilityCloaks(int count) {
  invisibilityCount_ += count;
}
